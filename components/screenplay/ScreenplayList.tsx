		...
		return (
			<div className="rounded-2xl border border-border bg-card shadow-sm">
				<div className="py-16 flex flex-col items-center justify-center text-center px-6">
					...
					<p className="text-foreground font-medium">まだ台本がありません</p>
	...
	return (
		<div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
			...
			<div className="hidden md:grid grid-cols-[1fr_auto_auto_auto] gap-4 items-center px-5 py-3 border-b border-border bg-muted/60">
				<div className="text-[10px] font-semibold tracking-[0.16em] uppercase text-muted-foreground">タイトル</div>
				<div className="text-[10px] font-semibold tracking-[0.16em] uppercase text-muted-foreground w-24 text-center">状態</div>
				<div className="text-[10px] font-semibold tracking-[0.16em] uppercase text-muted-foreground w-36 text-right">最終更新</div>
						...
						<li key={r.id}>
							...
							>
								<div className="min-w-0 flex items-center gap-3">
									<div className="w-9 h-9 rounded-lg bg-blue-600/10 ring-1 ring-blue-200 flex items-center justify-center shrink-0">
									...
									<div className="min-w-0">
										...
										<div className="text-[11px] text-muted-foreground mt-0.5 font-mono truncate md:hidden">
