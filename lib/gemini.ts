...
インフルエンサーは3〜5件、コンテンツアイデアは5件以上、競合ブランドは3〜5件提供してください。
有効なJSONのみを返してください（マークダウン不可）。すべての値は必ず日本語で記述してください。`
    : `You are a home shopping marketing research analyst. Based on the product information and web search results, generate a comprehensive research report.
...
Provide 3-5 competitors, 3-5 influencers, and 5+ content_ideas. Return only valid JSON, no markdown.`;
