	...
	for (let i = 0; i < ids.length; i += concurrency) {
		...
		const rows = results
			...
			.map((r) => ({
				...
				description_long: r.detail!.description_long,
				sku_variants: r.detail!.sku_variants,
				video_upload_date: r.detail!.video_upload_date,
				jsonld_raw: r.detail!.jsonld_raw,
